"""
Generate a unified-style 1×3 accuracy comparison plot for MAE, RMSE and MAPE.
Thesis-optimised for consistent A4 presentation.
"""
...
def main():
    ...
    fig.suptitle("Accuracy Comparison Across Methods and Datasets")
